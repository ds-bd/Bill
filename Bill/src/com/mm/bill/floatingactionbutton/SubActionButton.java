...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, FrameLayout.LayoutParams layoutParams, int theme,
            Drawable backgroundDrawable, View contentView, FrameLayout.LayoutParams contentParams) {
        super(context);
    ...
    public static class Builder {
        ...
        public SubActionButton build() {
            return new SubActionButton(context, layoutParams, theme, backgroundDrawable, contentView, contentParams);
        }
    }
}
